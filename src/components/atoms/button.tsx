  ...
  'rounded-full border cursor-pointer data-[disabled=true]:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-white text-black border-blue-100 hover:bg-blue-55 hover:border-blue-100 data-[disabled=true]:bg-blue-55 data-[disabled=true]:border-blue-55 data-[disabled=true]:text-gray-400',
        submit:
