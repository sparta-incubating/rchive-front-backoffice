...
const CustomCheckBoxVariants = cva('h-5 w-5 bg-center bg-no-repeat', {
  variants: {
    variant: {
      all: "data-[checked=true]:bg-[url('/backoffice/assets/icons/Checkbox.svg')] bg-[url('/backoffice/assets/icons/unCheckbox.svg')]",
      checked:
        "data-[checked=true]:bg-[url('/backoffice/assets/icons/Checked.svg')] bg-[url('/backoffice/assets/icons/unCheck.svg')]",
    },
  },
  defaultVariants: {
    variant: 'checked',
